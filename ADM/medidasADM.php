...
<body>
    <div class="container">
        ...
        <form method="GET" class="search-bar">
            ...
            <?php if ($modo_edicao): ?>
                <a href="medidasADM.php" class="btn-cancelar">Cancelar Edição</a>
            <?php endif; ?>
        </form>
            ...
            <form method="POST">
                ...
                <div class="insert-bar">
                    ...
                    <?php if ($modo_edicao): ?>
                        ...
                        <a href="medidasADM.php" class="btn-cancelar">Cancelar</a>
                    <?php else: ?>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="acao">
                            <a href="medidasADM.php?editar=<?= $medida['id'] ?>">Editar</a> | 
                            <a href="medidasADM.php?excluir=<?= $medida['id'] ?>" 
